...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { Author: @controller.Author, email: @controller.email, password: @controller.password, password_conformation: @controller.password_conformation, username: @controller.username }
    end
  ...
  test "should update controller" do
    put :update, id: @controller, controller: { Author: @controller.Author, email: @controller.email, password: @controller.password, password_conformation: @controller.password_conformation, username: @controller.username }
    assert_redirected_to controller_path(assigns(:controller))
  end
